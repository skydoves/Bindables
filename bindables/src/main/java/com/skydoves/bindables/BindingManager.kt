...
object BindingManager {
  ...
  @PublishedApi
  internal var bindingFieldsMap: HashMap<String, Int>? = null
  ...
  inline fun <reified T> bind(): Int {
    ...
    return storeDeclaredBindingFieldsIntoMap<T>()
  }
   ...
   */
  @PublishedApi
  internal inline fun <reified T> storeDeclaredBindingFieldsIntoMap(): Int {
